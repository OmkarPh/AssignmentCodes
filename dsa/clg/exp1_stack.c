// Convert  an infix expression to postfix expression using stack.  print contents of stack at all intermediate steps.
...
int main(){
  ...
  printf("Infix: (len: %lu): %s\n", strlen(str), str);
  printf("Postfix (len: %lu): %s\n", strlen(res), res);
